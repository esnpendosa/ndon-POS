...
<footer class="main-footer">
    <strong>Copyright &copy;<?=date('Y');?> <a href="https://rozitech.my.id/">Rozitech</a>.</strong>
    All rights reserved.
...
function jam() {
    ...
    if (!e) return; // hanya jalan kalau elemen #jam ada di halaman
    var d = new Date(),
        h, m, s;
    h = d.getHours();
    m = set(d.getMinutes());
...
// Jalankan jam jika elemen #jam ada (hanya di halaman home)
if (document.getElementById('jam')) { jam(); }
</script>
<script>
$(function() {

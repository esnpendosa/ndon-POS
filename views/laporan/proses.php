<?php
    // [SECURITY] Hanya Administrator yang berhak mengubah / menghapus riwayat transaksi
    if (empty($_SESSION['codekop_session']) || (int)$_SESSION['codekop_session']['akses'] !== 1) {
        set_flashdata("Gagal", "Akses ditolak. Hanya Administrator yang dapat mengubah data transaksi !", "danger");
        redirect("index.php");
        exit;
    }

        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="proses.php?aksi=update" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="">Harga jual (Eceran)</label>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="">Min. Qty Grosir <small class="text-danger">* Opsional</small></label>
                                <input type="number" min="0" class="form-control" value="<?= $edit->min_grosir ?? 0;?>"
                                    name="min_grosir" id="min_grosir" placeholder="Contoh: 12" />
                                <small class="text-muted">Isi 0 jika tidak ada harga grosir</small>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <label for="">Harga Grosir / Pcs <small class="text-danger">* Opsional</small></label>
                                <input type="text" id="rupiah3" class="form-control" value="<?= $edit->harga_grosir ?? 0;?>"
                                    name="harga_grosir" id="harga_grosir" placeholder="Contoh: 8.500" />
                                <small class="text-muted">Harga satuan saat beli &ge; Min Grosir</small>
                            </div>
                        </div>
                    </div>

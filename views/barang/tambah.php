                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" class="form-control" name="min_grosir" id="min_grosir" placeholder="Contoh: 12" value="0">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="harga_grosir" id="rupiah3" placeholder="Contoh: 8.500" value="0">
